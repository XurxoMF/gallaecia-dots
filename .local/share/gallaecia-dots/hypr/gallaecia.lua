...
local config = Gallaecia or {}

local mainMod = config.mainMod or "SUPER"

local terminal = config.terminal or "kitty"
local editor = config.editor or "nvim"
local ide = config.ide or "code"
local navegador = config.navegador or "firefox"
local explorador_de_arquivos = config.explorador_de_arquivos or "dolphin"
...
hl.env("IDE", ide)
hl.env("BROWSER", navegador)
hl.env("FILE_EXPLORER", explorador_de_arquivos)
