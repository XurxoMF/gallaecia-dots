...
# Substitúe unicamente a base compartida e controlada de Hyprland. O wrapper
# persoal de ~/.config/hypr/hyprland.lua permanece intacto.
...
show_changelog() {
  ...
  info "· Hyprland rexenerará os menús de KDE ao iniciar a sesión."
}

# Actualiza a base controlada de Hyprland e propaga calquera erro.
apply_update() {
